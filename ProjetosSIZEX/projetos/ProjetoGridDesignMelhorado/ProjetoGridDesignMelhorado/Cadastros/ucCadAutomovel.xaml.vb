...
#Region "Eventos Buttons - SUB"
    ...
    Private Sub SalvarBtn_Click(sender As Object, e As RoutedEventArgs) Handles SalvarBtn.Click
        ...
        Try
            ...
            srcVeiculos.Source = lstVeiculos.ToList
    ...
    Private Sub PesTxt_TextChanged(sender As Object, e As TextChangedEventArgs) Handles PesTxt.TextChanged
        If objVeiculo.lstVeiculos.Count > 0 Then
            If PesLbl.Content = "Pesquisa (Descrição):" Then
                srcVeiculos.Source = objVeiculo.lstVeiculos.Where(Function(p) p.Descricao.Contains(PesTxt.Text)).ToList
            ElseIf PesLbl.Content = "Pesquisa (Placa):" Then
                srcVeiculos.Source = objVeiculo.lstVeiculos.Where(Function(p) p.Placa.Contains(PesTxt.Text)).ToList
            ElseIf PesLbl.Content = "Pesquisa (Combustivel):" Then
                srcVeiculos.Source = objVeiculo.lstVeiculos.Where(Function(p) p.Combustivel.Contains(PesTxt.Text)).ToList
            Else
